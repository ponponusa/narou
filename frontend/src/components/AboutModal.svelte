...
{#if isOpen}
  ...
  >
    ...
    <div
      class="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto relative"
    ...
    >
      ...
      <div class="p-6 space-y-6">
        ...
        <div class="text-center">
          <div class="flex items-center justify-center gap-3 mt-4 mb-2">
            ...
            <span
              ...
              class="text-3xl font-bold text-blue-600 dark:text-blue-400 leading-8"
        ...
        <!-- プロジェクト情報 -->
        <div class="space-y-4">
          <h4 class="text-lg font-semibold text-gray-900 dark:text-white px-2">
            プロジェクト情報
          </h4>
          <div class="flex justify-center px-5">
            <div
              class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-3 w-full max-w-lg"
            >
              <div>
                ...
                <p class="text-gray-600 dark:text-gray-400">
                  Original: <a
                    href="https://github.com/whiteleaf7"
                    class="text-blue-600 dark:text-blue-400 hover:underline"
                    target="_blank"
                    rel="noopener noreferrer">whiteleaf7</a
                  >
                </p>
                <p class="text-gray-600 dark:text-gray-400">
                  Forked from: <a
                    href="https://github.com/Rumia-Channel"
                    class="text-blue-600 dark:text-blue-400 hover:underline"
                    target="_blank"
                    rel="noopener noreferrer">Rumia_Channel</a
                  >
                </p>
                <p class="text-gray-600 dark:text-gray-400">
                  MOD: <a
                    href="https://github.com/ponponusa"
                    class="text-blue-600 dark:text-blue-400 hover:underline"
                    target="_blank"
                    rel="noopener noreferrer">ponponusa</a
                  >
                </p>
              </div>
              <div>
        ...
        <!-- 説明 -->
        <div
          class="text-sm text-gray-600 dark:text-gray-400 pt-4 border-t border-gray-200 dark:border-gray-700"
        >
          <p>
            Narou.rb
            MODは、「小説家になろう」などの小説投稿サイトから作品をダウンロードし、
