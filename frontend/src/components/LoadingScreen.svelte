...
<div class="flex items-center justify-center min-h-[400px] py-12">
  <div class="text-center">
    ...
    <div class="relative inline-block">
      <div
        class="w-16 h-16 border-4 border-gray-200 dark:border-gray-700 border-t-blue-600 dark:border-t-blue-400 rounded-full animate-spin"
      ></div>
      <div
    ...
    <div class="mt-2 flex justify-center space-x-1">
      <div
        class="w-2 h-2 bg-blue-600 dark:bg-blue-400 rounded-full animate-bounce"
