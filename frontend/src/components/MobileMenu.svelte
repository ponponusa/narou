...
{#if isOpen}
  ...
  <!-- メニューパネル -->
  <div
    class="fixed top-16 right-0 w-64 bg-white dark:bg-gray-800 shadow-lg border-l border-gray-200 dark:border-gray-700 z-50 md:hidden"
  >
    <nav class="p-4 space-y-2">
      <!-- ナビゲーションリンク -->
      <a
        href="/"
        class="block px-4 py-3 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded transition-colors {currentPath ===
          '/' || currentPath === '/index.html'
          ? 'bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300'
          : ''} {$isServerStopped ? 'opacity-50 pointer-events-none' : ''}"
      ...
      <button
        class="w-full px-4 py-3 text-left text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded transition-colors {$isServerStopped
