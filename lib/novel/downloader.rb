...
require "narou/parsers/parser_selector"
...
require "cli/input"
require "narou/yaml_loader"
require "novel/downloader/errors"
require "novel/downloader/sanitize"
require "novel/downloader/class_methods"
require "novel/downloader/file_operations"
require "novel/downloader/database_updater"
require "novel/downloader/section_downloader"
require "novel/downloader/toc_processor"
  ...
  def run_download
    ...
    when true
      unless tags.include?("end")
        ...
        require "novel/command/tag" unless defined?(Command::Tag)
...
更新後の話数: #{latest_subtitles_count}
      ...
      loop do
        ...
        when "2"
          return true
        when "3"
          require "novel/command/freeze" unless defined?(Command::Freeze)
          Command::Freeze.execute!(latest_toc["toc_url"])
          return true
        when "4"
          require "novel/command/backup" unless defined?(Command::Backup)
        ...
        when "8"
          require "novel/command/convert" unless defined?(Command::Convert)
