...
class NovelSetting
  ...
  ORIGINAL_SETTINGS = [
    ...
    },
    {
      ...
      type: :boolean,
      value: false,
      help: "文字選択がしやすいように１文字ずつ区切りデータを挿入する（Kindle専用。enable_insert_word_separator が有効な場合この設定は無視される）" \
            "※Kindle ファームウェア 5.9.6.1 から MOBI ファイルでも単語選択が可能になったので、この機能を使う必要がなくなりました"
    },
    {
