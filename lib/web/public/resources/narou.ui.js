...
$(function() {
  ...
  var cell_visible = (touchable_device ?
      // スマフォ系端末
      {
        ...
        download: true, folder: false, epub: true, update_button: false, general_lastup: false,
    ...
    : {
        ...
        download: false, folder: true, epub: true, update_button: true, general_lastup: true,
        general_all_no: false, last_check_date: false, length: false, average_length: false,
        story: false,
      });
  ...
  function initializeDataTable() {
    ...
    columns: [
      ...
      {
        title: "epub",
        data: "epub", className: "text-center", orderable: false,
        searchable: false, visible: cell_visible.epub,
        width: "25px",
        defaultContent: '<button class="btn btn-default btn-xs">' +
                        '<span class="glyphicon glyphicon-folder-open"></span></button>',
        createdCell: function(td, cellData, rowData, rowIndex, colIndex) {
          $(td).children("button")
            ...
            .on("click", function(e) {
              ...
              var $this = $(this);
              var target_id = $this.data("targetId");
              window.location.href = '/api/epub/download/' + target_id;
            });
        },
        render: function() {}
      },
