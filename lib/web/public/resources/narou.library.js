...
var Narou = (function() {
  ...
  $.extend(Action.prototype, {
    ...
    update: function() {
      ...
      var ids = this._getSelectedIds(arguments);
      console.log("[DEBUG] update collected IDs:", ids);
      console.log("[DEBUG] selectedIds Set size:", this.selectedIds.size);
      console.log("[DEBUG] selectedIds Set contents:", Array.from(this.selectedIds));
...
<label><input type="checkbox" id="update-gl-and-update-modified" <% if (updateModified) { %>checked<% } %>> 確認後にmodifiedタグが付いた小説をUpdate</label>
    ...
    updateForce: function() {
      var ids = this._getSelectedIds(arguments);
      console.log("[DEBUG] updateForce collected IDs:", ids);
