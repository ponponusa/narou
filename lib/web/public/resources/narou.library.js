    ...
    openEditor: function() {
      ...
      $.get("/api/sort_state", function(sortState) {
          ...
          buttons: {
            ...
            main: {
              ...
              callback: function() {
                ...
                console.log("タグ編集API呼び出し:", { ids: ids, states: states });
        ...
        setTimeout(function() {
          ...
          console.log("[DEBUG] Looking for #tag-editor-field in dialog:", $(".bootbox #tag-editor-field").length);
          self.setDefaultTagState($(".bootbox #tag-editor-field"));
        }, 500);
          });
        }).fail(function() {
          // ソート状態取得に失敗した場合は従来通りの処理
